...
func main() {
	...
	Ceph.Init2( /*"http://172.16.20.15"*/ "http://172.28.64.229:7480", "my-first-s3-bucket", "IC12PTXGDS1GOC1QEAUX", "tRwaFbEFoQJrFKrITpL9DFkKblexIDUT8EK13Vkr")
	// Ceph.Download("D:\\cmcc\\CEPH\\s3cmdconfigure.txt", "./s3cmdconfigure.txt")
	// Ceph.Upload("1.mp4", "api/rest/2017-3-16-10-38.mp4")
	Ceph.Upload("D:\\cmcc\\CEPH\\s3cmdconfigure.txt", "s3cmdconfigure.txt")
	// Ceph.Download("s3cmdconfigure.txt", "./s3cmdconfigure.txt")
}
